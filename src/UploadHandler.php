...
class UploadHandler
{
                                   ...
                                   $index, $content_range)
  {
    ...
    return $this->get_unique_filename(
            ...
            $this->fix_file_extension($file_path, $name, $size, $type, $error,
                $index, $content_range), $size, $type, $error, $index,
            $content_range
    );
  }
  ...
  {
    $image = (isset($this->image_objects[$file_path])) ? $this->image_objects[$file_path]
          : null;
  ...
  protected function gd_create_scaled_image($file_name, $version, $options)
  {
    ...
    $success = imagecopyresampled(
            $new_img, $src_img, $dst_x, $dst_y, 0, 0, $new_width, $new_height,
            $img_width, $img_height
  ...
  public function generate_response($content, $print_response = true)
  {
    ...
    if ($print_response) {
      ...
      if ($redirect && preg_match($this->options['redirect_allow_target'],
              $redirect)) {
